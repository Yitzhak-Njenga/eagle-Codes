        ...
        <div class="row key-row">
            ...
            <div class="col-md-4">
                <div class="key-col">
                    ...
                    <p style="font-size: 15px">We craete Web application development will typically have a short development life-cycle lead by a small development team. Front-end development for web applications is accomplished through client-side programming</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="key-col">
            ...
            <div class="col-md-4">
                <div class="key-col">
                    ...
                    <p style="font-size: 15px">We create design dedicated to ensuring your visual communication, work on creating materials for corporate clients, advertising agencies, public relations firms, and <publishers></publishers>.</p>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 about">
                <h2>About Us</h2>
                <p style="font-size: larger">Eagle Codes is a software Engeenering Company specializes in building software solutions for churches,schools organizations, and business and we will help your business to grow and prosper in the corporate world through our invovative technology. </p>
